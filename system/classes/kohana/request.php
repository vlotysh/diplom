...
class Kohana_Request implements HTTP_Request {
	...
	/**
	 * Возвращает принятые кодировки. If a specific encoding is defined,
	...
	/**
	 * Обрабатывает запрос, выполняя действия контроллера, который обрабатывает этот 
         * запрос, определяется [маршрутом Route].
	 *
